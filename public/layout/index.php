    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">{nama.admin}</a>
            </div>
            <!-- /.navbar-header -->

            <ul class="nav navbar-top-links navbar-right">
                <small>Selamat Datang <b>{ username }</b></small>
                <li class="dropdown">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> Blog dan News { Your Company }
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            { tampilan isi data blog news }
                        </div>
                        <!-- /.panel-body -->
                    </div>
                    <!-- /.panel -->
